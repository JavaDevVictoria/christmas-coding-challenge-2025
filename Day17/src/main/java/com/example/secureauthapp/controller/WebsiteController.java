...
public class WebsiteController {
    ...
    public String registerUser(
            ...
            @RequestParam String firstname, // Firstname from the form
            @RequestParam String lastname, // Lastname from the form
        ...
        try {
            userDetailsService.registerUser(username, firstname, lastname, email, password, role);
